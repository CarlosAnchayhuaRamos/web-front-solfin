import { ApprovalStatus, InterestCalculationMethod, PaymentFrequency } from '@prisma/client';
...
export interface CreditContractData {
  penaltyTerms: import('../parameters/parameters.types').PenaltyFrequencySetting;
  advisorName: string;
  approvedAt: string;
